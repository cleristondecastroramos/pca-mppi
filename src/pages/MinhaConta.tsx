...
const avatarOptions = [
  ...
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Caleb&backgroundColor=e2e8f0",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Christian&backgroundColor=e2e8f0",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=David&backgroundColor=e2e8f0",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Dylan&backgroundColor=e2e8f0",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Ethan&backgroundColor=e2e8f0",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Gabriel&backgroundColor=e2e8f0",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Henry&backgroundColor=e2e8f0",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Isaac&backgroundColor=e2e8f0",
  "https://api.dicebear.com/7.x/avataaars/svg?seed=Julian&backgroundColor=e2e8f0",
