...
export function getTutorialSections(): PdfSection[] {
  return [
    ...
    {
      id: "sec8",
      title: "8. Licitações SRP (Sistema de Registro de Preços)",
      content: [
        ...
        { type: "h3", text: "8.1. Diferenciais do Módulo SRP" },
        { type: "ul", items: [
        ...
        { type: "h3", text: "8.2. Progressão Automática de Status" },
    ...
    // 9. Nova Contratação
    {
      ...
      content: [
        ...
        { type: "h3", text: "8.5. Cálculo Automático da Data Prevista de Início" },
    ...
    // 10. Setores Demandantes
    {
      ...
      content: [
        { type: "p", text: "O módulo Setores Demandantes oferece uma visão consolidada e analítica de todas as contratações organizadas por setor requisitante. É uma ferramenta estratégica voltada para Administradores e Gestores, cobrindo os 13 setores cadastrados: CAA, CCF, CCS, CEAF, CLC, CONINT, CPPT, CRH, CTI, GAECO, GSI, PLANEJAMENTO e PROCON." },

        { type: "h3", text: "10.1. Indicadores (KPIs) com Régua de Evolução" },
        { type: "p", text: "Na parte superior da página são exibidos quatro indicadores consolidados que refletem o perfil financeiro das contratações filtradas:" },
        { type: "ul", items: [
          "Quantidade de Demandas: Total de contratações cadastradas (ou filtradas).",
          "Valor Estimado: Soma dos valores originalmente planejados para as contratações.",
          "Valor Executado: Soma dos empenhos realizados. Exibe uma régua de progresso discreta e o percentual executado em relação ao valor estimado. A cor da régua varia conforme o nível de execução: azul para execução baixa (< 40%), ciano para execução moderada (40%–79%) e verde para execução elevada (≥ 80%). Passe o cursor sobre o card para ver o percentual exato.",
          "Saldo Orçamentário: Diferença entre o valor estimado e o valor executado. Também exibe régua de progresso, representando o percentual de saldo ainda disponível. A cor varia conforme a situação: verde quando há saldo amplo (> 20% do estimado), âmbar quando o saldo está crítico (≤ 20%) e vermelho quando o saldo é negativo (execução excedeu o estimado).",
        ] },
        ...
        { type: "p", text: "A barra de filtros permite refinar a visualização de demandas por três critérios combinados:" },
        { type: "ul", items: [
          "Setor: Botões de seleção rápida para cada um dos 13 setores. Ao selecionar, a tabela e os KPIs são atualizados automaticamente.",
          "Tipo de Contratação: Nova Contratação, Renovação, Aditivo Quantitativo, Repactuação, Apostilamento e Indeterminado.",
          "Status: Não Iniciado, Em Andamento, Concluído e Sobrestado.",
        ] },

        { type: "h3", text: "10.3. Legenda Visual" },
        { type: "p", text: "Acima da tabela de demandas há uma legenda completa com a representação visual de todos os status e situações de prazo:" },
        { type: "ul", items: [
          "Status — Não Iniciado: Círculo cinza (processo na etapa de Planejamento, sem movimentação).",
          "Status — Iniciado: Círculo azul (processo iniciado pelo setor requisitante).",
          "Status — Retornado: Círculo amarelo (processo retornado ao setor para diligência).",
          "Status — Em Andamento: Círculo índigo (processo em fase de licitação ou já contratado).",
          "Status — Concluído: Círculo verde (processo encerrado com sucesso).",
          "Status — Sobrestado: Círculo laranja (processo temporariamente suspenso).",
          "Prazo — No Prazo: Badge verde (dentro do prazo esperado).",
          "Prazo — Atenção (≤30d): Badge âmbar (prazo se aproximando, menos de 30 dias).",
          "Prazo — Atrasado: Badge vermelho (já passou da data de referência).",
        ] },

        { type: "h3", text: "10.4. Tabela de Demandas — Colunas" },
        { type: "p", text: "A tabela principal exibe as seguintes colunas para cada contratação:" },
        { type: "ul", items: [
          "Cod. PCA: Código abreviado no formato XXXX (sem o prefixo PCA- e sem o sufixo -2026).",
          "Tipo de Material/Serviço: Descrição do objeto da contratação. Textos longos são truncados; passe o cursor sobre a célula para ver a descrição completa.",
          "Valor Estimado: Valor originalmente planejado, em reais.",
          "Valor Executado: Soma dos empenhos registrados (Empenho 1 + 2 + 3), em reais.",
          "Saldo Orçamentário: Diferença entre o valor estimado e o executado. Exibido em vermelho quando negativo.",
          "Status: Situação atual do processo, representada por um círculo colorido e um rótulo textual. Passe o cursor para ver a descrição da etapa.",
          "Prazo: Badge colorido indicando a situação do prazo (No Prazo, Atenção ou Atrasado). Passe o cursor para ver o tooltip com datas e contagem de dias.",
        ] },

        { type: "h3", text: "10.5. Coluna Status — Regras de Visualização" },
        { type: "p", text: "O status de cada contratação é determinado automaticamente com base na etapa do processo e na situação de sobrestamento:" },
        { type: "table",
          headers: ["Status", "Cor", "Condição"],
          rows: [
            ["Não Iniciado", "Cinza", "Etapa nula ou igual a 'Planejamento'"],
            ["Iniciado", "Azul", "Etapa = 'Iniciado'"],
            ["Retornado", "Amarelo", "Etapa = 'Retornado para Diligência'"],
            ["Em Andamento", "Índigo", "Etapa = 'Em Licitação' ou 'Contratado'"],
            ["Concluído", "Verde", "Etapa = 'Concluído'"],
            ["Sobrestado", "Laranja", "Campo 'sobrestado' = verdadeiro (independe da etapa)"],
          ],
          headerAlign: ["left", "left", "left"],
        },

        { type: "h3", text: "10.6. Coluna Prazo — Regras de Cálculo" },
        { type: "p", text: "A coluna Prazo exibe um badge colorido com base na situação do processo em relação ao seu cronograma. A data de referência para o cálculo de dias varia conforme o andamento da contratação:" },
        { type: "ul", items: [
          "Processos Não Iniciados (etapa nula ou Planejamento): O cálculo de dias é feito em relação à Data Prevista de Início, calculada automaticamente com base na modalidade (150 dias antes para Pregão/Concorrência, 90 dias para Dispensa/Inexigibilidade/ARP, ou 120 dias para demais modalidades). Um processo não iniciado pode aparecer como 'Atrasado' mesmo que a data de conclusão ainda não tenha passado, se o prazo ideal para começar já foi ultrapassado.",
          "Processos Em Andamento (Iniciado, Retornado, Em Licitação, Contratado): O cálculo é feito em relação à Data Prevista de Conclusão (data_prevista_contratacao).",
          "Processos Concluídos, Cancelados ou Sobrestados: Não exibem badge de prazo (mostram apenas um traço '—').",
        ] },
        { type: "table",
          headers: ["Badge", "Cor", "Condição"],
          rows: [
            ["No Prazo", "Verde", "Mais de 30 dias restantes até a data de referência"],
            ["Atenção", "Âmbar", "Entre 0 e 30 dias até a data de referência"],
            ["Atrasado", "Vermelho", "Data de referência já passou (dias negativos)"],
          ],
          headerAlign: ["left", "left", "left"],
        },

        { type: "h3", text: "10.7. Tooltip da Coluna Prazo" },
        { type: "p", text: "Ao posicionar o cursor sobre o badge de prazo, um tooltip estruturado é exibido com as seguintes informações:" },
        { type: "ul", items: [
          "🚀 Início previsto: Data a partir da qual o processo deveria estar em andamento, calculada automaticamente com base na modalidade e na data de conclusão. Exibida no formato dd/mm/aaaa.",
          "🏁 Conclusão prevista: Data-alvo para a finalização da contratação (data_prevista_contratacao), no formato dd/mm/aaaa.",
          "Contagem de dias: Linha destacada ao final do tooltip indicando quantos dias faltam para a data de referência (início ou conclusão) ou há quantos dias o processo está atrasado. O texto contextualiza se os dias se referem ao início ('p/ início') ou à conclusão ('p/ conclusão').",
        ] },
        { type: "note", text: "Exemplo de tooltip para um processo Não Iniciado com prazo vencido: '🚀 Início previsto: 15/01/2026 | 🏁 Conclusão prevista: 15/05/2026 | Atrasado no início há 25 dia(s)'. Para um processo Em Andamento no prazo: '🚀 Início previsto: 10/02/2026 | 🏁 Conclusão prevista: 10/06/2026 | Faltam 45 dia(s) p/ conclusão'." },

        { type: "h3", text: "10.8. Paginação" },
        { type: "p", text: "A tabela exibe até 15 registros por página. Use os botões 'Anterior' e 'Próxima' para navegar entre as páginas. O rodapé indica a página atual, o total de páginas e o número total de itens." },

        { type: "h3", text: "10.9. Utilidade Estratégica" },
        { type: "p", text: "Este módulo é especialmente útil para reuniões de planejamento e acompanhamento gerencial, pois permite identificar setores com maior volume de demandas, comparar a execução financeira em relação ao planejado, verificar processos em risco de atraso e monitorar o saldo orçamentário de cada área. Administradores podem utilizar essas informações para redistribuir recursos, ajustar prioridades e garantir o equilíbrio orçamentário entre os setores." },
      ],
    },
    // 11. Controle de Prazos
    {
      ...
      content: [
        ...
        { type: "h3", text: "11.3. Filtros Disponíveis" },
        ...
        { type: "h3", text: "11.4. Edição de Datas" },
        ...
        { type: "h3", text: "11.5. Indicadores Resumidos" },
    ...
    // 12. Pontos de Atenção
    {
      ...
      content: [
        ...
        { type: "h3", text: "12.2. Informações Exibidas" },
        ...
        { type: "h3", text: "12.3. Navegação por Abas" },
        ...
        { type: "h3", text: "12.4. Finalidade Estratégica" },
    ...
    // 13. Prioridades de Contratação
    {
      ...
      content: [
        ...
        { type: "h3", text: "13.1. Niveis de Prioridade" },
        ...
        { type: "h3", text: "13.4. Status das Contratações" },
        ...
        { type: "h3", text: "13.5. Alteração de Prioridade" },
        ...
        { type: "h3", text: "13.6. Importância para a Gestão" },
    ...
    {
      id: "sec14",
      title: "14. Avaliação e Conformidade",
      content: [
        ...
        { type: "h3", text: "14.3. Como Auditar uma Contratação" },
        ...
        { type: "h3", text: "14.4. Filtros e Exportação" },
        ...
        { type: "h3", text: "14.5. Importância para o Processo" },
    ...
    {
      id: "sec15",
      title: "15. Resultados Alcançados",
      content: [
        ...
        { type: "h3", text: "15.1. KPIs (Indicadores-Chave de Desempenho)" },
        ...
        { type: "h3", text: "15.2. Gráficos Analíticos" },
        ...
        { type: "h3", text: "15.3. Tabela de Valor Contratado por Setor" },
        ...
        { type: "h3", text: "15.4. Finalidade Estratégica" },
    ...
    // 16. Relatórios
    {
      ...
      content: [
        ...
        { type: "h3", text: "16.1. Tipos de Relatório Disponíveis" },
        ...
        { type: "h3", text: "16.2. Filtros Avançados" },
        ...
        { type: "h3", text: "16.3. Formatos de Exportação" },
        ...
        { type: "h3", text: "16.4. Visualização Prévia" },
        ...
        { type: "h3", text: "16.5. Finalidade Estratégica" },
    ...
    // 17. Orçamento Planejado
    {
      ...
      content: [
        ...
        { type: "h3", text: "17.3. Sincronização com o Planejamento" },
        { type: "p", text: "O botão \"Preencher do Planejado\" automatiza a definição dos limites orçamentários. Ao ser acionado, o sistema realiza a soma instantânea de todos os Valores Estimados de todas as contratações cadastradas (que não estejam canceladas), agrupando-as por Setor e por Unidade Orçamentária (PGJ, FMMP, FEPDC)." },
        { type: "p", text: "Esta funcionalidade garante que os limites informados na tabela correspondam exatamente ao que foi planejado detalhadamente no PCA, eliminando erros de digitação e facilitando o fechamento do planejamento anual." },
        { type: "h3", text: "17.4. Auditoria" },
    ...
    {
      id: "sec18",
      title: "18. Gerenciamento de Usuários",
      content: [
        { type: "p", text: "Exclusivo do Administrador." },
        { type: "h3", text: "18.1. Criar Usuário" },
        { type: "ol", items: [
    ...
    // 19. Notificações
    {
      ...
      content: [
        ...
        { type: "h3", text: "19.1. Como Criar uma Notificação" },
        ...
        { type: "h3", text: "19.2. Como os Usuarios Recebem as Notificacoes" },
        ...
        { type: "h3", text: "19.3. Gerenciamento de Notificacoes" },
        ...
        { type: "h3", text: "19.4. Casos de Uso Recomendados" },
    ...
    // 20. Minha Conta
    {
      ...
      content: [
        ...
        { type: "h3", text: "20.1. Informações Editáveis" },
        { type: "ul", items: [
        ...
        { type: "h3", text: "20.2. Informações Somente Leitura" },
        ...
        { type: "h3", text: "20.3. Alteração de Senha" },
    ...
    // 21. FAQ / Dúvidas
    {
      ...
      content: [
        ...
        { type: "h3", text: "21.1. Conteúdo da Seção" },
        { type: "ul", items: [
        ...
        { type: "h3", text: "21.2. Canais de Suporte" },
    ...
    {
      id: "sec22",
      title: "22. Glossário de Termos e Siglas",
      content: [
        { type: "h3", text: "22.1. Siglas" },
        {
          type: "table",
