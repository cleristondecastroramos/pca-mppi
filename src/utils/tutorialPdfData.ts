  ...
  return [
    ...
    // 9. Setores Demandantes
    {
      ...
      content: [
        ...
        { type: "p", text: "A tabela principal exibe as seguintes informações de cada contratação: Código PCA (no formato PCA-XXXX-2026), Descrição resumida do objeto, Classe (Material ou Serviço), Modalidade de contratação, Valor Estimado, Valor Contratado, Saldo Orçamentário, Empenhos (1º, 2º e 3º) e Etapa do Processo. Todos os valores monetários são formatados no padrão brasileiro (R$)." },
    ...
    // 18. Notificações
    {
      ...
      content: [
        ...
        { type: "h3", text: "18.2. Como os Usuários Recebem as Notificações" },
        { type: "p", text: "Todas as notificações ativas são exibidas no ícone de sino (🔔) localizado no canto superior direito do cabeçalho do sistema:" },
        { type: "ul", items: [
          "Indicador de não lida: Um ponto vermelho aparece sobre o ícone do sino quando há mensagens pendentes.",
          "Dropdown de notificações: Ao clicar no sino, um menu suspenso exibe a lista de notificações ativas.",
          "Marcação automática como lida: Ao abrir o dropdown, todas as notificações são marcadas como lidas.",
          "Controle individual de leitura: Cada usuário possui seu próprio registro de leitura.",
        ] },
        { type: "h3", text: "18.3. Gerenciamento de Notificações" },
        { type: "p", text: "Na página de Notificações, o Administrador visualiza o Histórico de Notificações Ativas em uma tabela. As seguintes ações estão disponíveis:" },
        { type: "ul", items: [
          "Excluir (inativar): O Administrador pode remover uma notificação clicando no ícone de lixeira (🗑️). A exclusão é lógica — a notificação é marcada como inativa.",
        ] },
